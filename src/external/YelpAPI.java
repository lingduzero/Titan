...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "G7rPaScOrbrrUvcDl-1crA";
	private static final String CLIENT_SECRET = "Zh3aBILDGeI3bs3hdZ3ek6E46lnB4l4NMDR2v3JmahKe7a90tRsAQLbfCxesqCHg";
	...
	private List<Item> getItemList(JSONArray array) throws JSONException {
		...
		for (int i = 0; i < array.length(); i++) {
			...
			builder.setCategories(categories).setName(object.getString("name"))
					.setImageUrl(object.getString("image_url")).setRating(object.getDouble("rating"));
			...
			builder.setCity(location.getString("city")).setState(location.getString("state"))
					.setZipcode(location.getString("zip_code"));
